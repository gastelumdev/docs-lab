...
export const selectData = (state: RootState) => state.pages.data;
export const selectCreatedData = (state: RootState) => state.pages.createdData;
export const selectOneData = (state: RootState) => state.pages.oneData;
export const selectStatus = (state: RootState) => state.pages.status;
export const selectError = (state: RootState) => state.pages.err;
